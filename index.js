...
const user_input_data = new mongoose.Schema({
    ...
    password: {//Unaccessible in database
        type: String,
...
user_input_data.methods.correctPassword = async function(candidatePassword, userPassword) {
...
const get_data_customer = catchAsync(async (req, res) => {
    ...
    const data = await User.find({}, {_id: 0, problem_name: 1, problem_description: 1, problem_priority: 1, problem_photo: 1, person_in_charge: 1, problem_status: 1, estimated_time: 1})
